...
Once the environment is ready, return to the user's original task and continue with the TaskSpace flow in `SKILL.md` — start from `egoBrowser.newTaskSpace(name)` and proceed as usual.
