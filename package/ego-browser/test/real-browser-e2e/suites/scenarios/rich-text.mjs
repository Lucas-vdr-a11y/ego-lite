...
export const richTextScenarioCase = scenarioCase(
  ...
  `
      ...
      await articleTitle.fill("Temporary title");
      await articleTitle.fill("");
      ...
      await articleTitle.fill("Singapore pilot release");
      ...
      await page.getByLabel("Link URL").fill("https://example.com/releases/editorial-quality");
      await page.getByLabel("Link URL").press("Enter");
