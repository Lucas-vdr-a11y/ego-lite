...
export const reviewWorkflowScenarioCase = scenarioCase(
  ...
  `
      ...
      await observedAction(page, page.getByLabel("Lead reviewer", { exact: true }), "selectOption", "Aisha Rahman");
      await observedAction(page, assign, "click");
      ...
      await observedAction(page, page.getByLabel("Acting as"), "selectOption", "reviewer");
      ...
      await observedAction(page, page.getByRole("button", { name: "Add finding" }), "click");
      ...
      await observedAction(page, page.getByLabel("Finding severity"), "selectOption", "Advisory");
      await observedAction(page, page.getByRole("textbox", { name: "Review finding", exact: true }), "fill", "The recyclability claim needs the supplier certificate.");
      await observedAction(page, page.getByRole("button", { name: "Add finding" }), "click");
      ...
      await observedAction(page, page.getByRole("button", { name: "Request changes" }), "click");
      ...
      await observedAction(page, page.getByLabel("Acting as"), "selectOption", "author");
      ...
      await observedAction(page, page.getByRole("button", { name: "Mark findings resolved" }), "click");
      ...
      await observedAction(page, page.getByRole("button", { name: "Approve review" }), "click");
