...
export const clicksScenarioCase = scenarioCase(
  ...
  `
      ...
      await observedAction(page, page.getByRole("button", { name: "More actions" }), "click");
      ...
      await observedPageKey(page, "Place selected order on hold", "Escape");
      ...
      await observedAction(page, page.getByRole("button", { name: "More actions" }), "click", { button: "right" });
      ...
      await observedAction(page, filter, "click");
      ...
      await observedAction(page, page.getByRole("button", { name: "Show ready orders" }), "click");
      assertEqual(await page.getByTestId("visible-order-count").textContent(), "3", "filter action restores the ready-only queue");
      await observedAction(page, page.getByRole("button", { name: "Select order EG-1846" }), "click");
      ...
      await observedAction(page, approve, "click");
      ...
      await observedAction(page, page.getByRole("button", { name: "Select order EG-1842" }), "click");
      ...
      await observedAction(page, page.getByRole("menuitem", { name: "Place selected order on hold" }), "click");
      ...
      await observedAction(page, page.getByRole("button", { name: "Reset activity" }), "click");
